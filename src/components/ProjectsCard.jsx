...
const ProjectsCard = ({
  ...
  return (
    ...
    <article className="flex self-start flex-col gap-6 rounded-2xl bg-white/80 p-6 dark:bg-slate-900/60 border border-gray-200 hover:border-2 hover:border-blue-500 transition-colors duration-300">
      {/* Project image */}
